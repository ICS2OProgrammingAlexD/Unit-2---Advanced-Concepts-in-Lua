...
local bkgMusic = audio.loadStream("Sounds/bensound-creativeminds.mp3")
...
local function DisplayQuestion()
    ...
    --set random numbers
    randomNumber1 = math.random(4, 20)
    randomNumber2 = math.random(8, 25)
...
local function CheckUserAnswerInput()
    ...
    elseif (lives == 0) then 
        timer.performWithDelay(1600, YouLoseTransition)
    else 
